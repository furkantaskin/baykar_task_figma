...
<main>
    <section class="top">
        <div class="banner position-relative">
            <div class="banner_upper d-flex flex-column flex-md-row position-relative px-4 py-12 px-lg-20 gap-lg-20">
                <div class="banner_upper_text d-flex flex-column justify-content-md-center gap-8">
                    <h1 class="text-center text-mf-dark m-0 text-lg-start">Collectible Sneakers</h1>
                    <p class="txt text-mf-dark text-center text-lg-start">Sit elit feugiat turpis sed integer integer
                        accumsan
                        turpis.
                        Sed
                    ...
                    <div
                        class="banner_nav d-flex justify-content-center align-items-center justify-content-md-start gap-4">
                ...
                <div class="img_wrapper position-relative w-md-50 mx-md-auto">
                    <picture>
            ...
            <div
                class="banner_lower d-flex align-items-start justify-content-center flex-column flex-md-row py-12 px-4 px-lg-20 gap-8 bg-mf-yellow">
                <div class="banner_card position-relative d-flex flex-column align-items-center align-items-lg-start">
                    ...
                    <p class="txt text-mf-dark text-center text-lg-start">Sit bibendum donec dolor fames neque vulputate
                        non
                        sit aliquam.
                        Consequat turpis
                        natoque leo, massa.
        ...
        <div class="prods d-flex flex-column text-center py-12 px-4 px-lg-20 gap-8 bg-mf-dark overflow-x-hidden">
            <div
            ...
            <div class="cards_wrapper d-flex flex-column flex-md-row gap-8">
                <?php for ($i = 1; $i <= 3; $i++): ?>
                    <div class="position-relative card_wrapper">
                        ...
                        <div class="prods_card position-relative z-1 text-start text-white pb-8">
                            ...
                            <p class="txt txt-light mb-8 px-8 py-0">Egestas elit dui scelerisque ut eu purus aliquam vitae
                                habitasse.</p>
                            <a href="" class="btn btn-dark my-0 mx-8 mx-md-4 p-4" title="Show now">
                                <img src="<?= domain ?>assets/img/svg/shopping-cart.svg" alt="Add to cart icon"
                                    loading="lazy">
    ...
    <section class="join pt-4 px-4 pb-14 overflow-x-hidden">
    ...
    <section class="testimonials overflow-x-hidden py-12 px-0">
        <div class="testimonials_heading d-flex justify-content-between align-items-center text-center mb-8">
            <span class="heading text-mf-dark d-blok w-100">Because they love us</span>
    ...
    <section class="collection pt-12 overflow-x-hidden position-relative">
        <div class="cm-container d-flex flex-column gap-8">
            <span class="heading text-mf-dark text-center">Grow your collection</span>
            <p class="txt text-mf-dark text-center mb-0">Enim neque massa porta adipiscing elit. Sem libero id faucibus
                nibh
            ...
            <div class="mt-n4 d-flex flex-column gap-8 align-items-start">
                <div class="buttons vw-100 d-flex flex-row overflow-x-scroll me-n4 ms-n4 ps-4 py-4 gap-4">
                    <?php
                    ...
                    for ($i = 0; $i <= 5; $i++): ?>
                        <div class="button d-flex p-4 rounded-3 <?= $i == 0 ? 'active' : '' ?>">
                            <picture>
                            ...
                            <span class="d-block px-4 text-mf-dark">
                                <?= $texts[$i] ?>
                            </span>
                            <picture>
                                ...
                                <img src="<?= domain ?>assets/img/png/arrow-right.png" alt="right arrow"
                                    class="arrow d-none" loading="lazy">
                            </picture>
                        </div>
                    <?php endfor; ?>
                </div>
                    ...
                    <div class="frame-window position-relative">
                        ...
                        <div class="screen position-relative bg-white">
                            <picture>
                                <source srcset="<?= domain ?>assets/img/webp/thumbnail.webp" type="image/webp">
                                <source srcset="<?= domain ?>assets/img/png/thumbnail.png" type="image/png">
                                <img src="<?= domain ?>assets/img/png/thumbnail.png" alt="Shoes" loading="lazy"
                                    class="w-100 object-fit-cover">
                            </picture>
                        </div>
                    </div>
                    <div class="frame-window position-absolute">
                        ...
                        <div class="screen position-relative bg-white">
                            <picture>
                                <source srcset="<?= domain ?>assets/img/webp/thumbnail.webp" type="image/webp">
                                <source srcset="<?= domain ?>assets/img/png/thumbnail.png" type="image/png">
                                <img src="<?= domain ?>assets/img/png/thumbnail.png" alt="Shoes on shelf" loading="lazy"
                                    class="w-100 object-fit-cover">
                            </picture>
                        </div>
                    </div>
    ...
    <section class="world py-12 bg-mf-amber overflow-x-scroll">
